...
If the folder you open in Obsidian contains `.obsidian`, that folder is usually the vault root and should be used as `VAULT_PATH`:
...
| --- | --- | --- |
| `VAULT_PATH` | current working directory | Absolute path to your Obsidian vault root, for example `C:\path\to\your\obsidian-vault` |
